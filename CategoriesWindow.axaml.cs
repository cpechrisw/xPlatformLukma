...
public partial class CategoriesWindow : Window
{
    ...
    private void InitializeEvents()
    {
        ...
        //
        //
        //Left off here, compare with LukmaCatNamesForm.Designer.cs
        //
        //
        //
    ...
    private void Add_Category(object sender, EventArgs e) //add category to text file and list box
    {
        if (txtBox_NewCategory.Text != null)
        {
            ...
            {
                MessageBox.Avalonia.MessageBoxManager.GetMessageBoxStandardWindow("Warning", "That Already Exists").Show();
                //MessageBox.Show("That Already Exists");
            }
    ...
    private void Enable_Category_Textbox(object sender, EventArgs e) //enables "Add" Button for Categories
    {
    ...
    private void Enable_Name_Textbox(object sender, EventArgs e)  //enables "Add" Button for Names
    {
    ...
    private void Enable_Name_AddTextBox(object sender, EventArgs e) //enables "Add" Button for Categories
    {
        if (lsbox_Categories.SelectedItem != null)
        {
            txtBox_NewName.IsEnabled = true;
    ...
    private void Enable_Name_Removal(object sender, EventArgs e) //enables "Add" Button for Categories
    {
    ...
    private void AddCategory_KeyDown(object sender, KeyEventArgs e) //adds category when enter key is pressed
    {
        if (e.Key == Key.Enter)
        {
            Add_Category(this, new EventArgs());
        }
    }
    private void AddName_KeyDown(object sender, KeyEventArgs e) //adds name when enter key is pressed
    {
        if (e.Key == Key.Enter)
        {
            Add_Name(this, new EventArgs());
        }
    }
